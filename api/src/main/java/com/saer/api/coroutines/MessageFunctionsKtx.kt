...
suspend fun TelegramFlow.addLocalMessage(
  chatId: Long,
  senderUserId: TdApi.MessageSender,
  replyToMessageId: Long,
  disableNotification: Boolean,
  inputMessageContent: TdApi.InputMessageContent?
): TdApi.Message = this.sendFunctionAsync(TdApi.AddLocalMessage(chatId, senderUserId, replyToMessageId,
 ...
 */
suspend fun TelegramFlow.getMessageLink(chatId: Long, messageId: Long, mediaTimestamp: Int, forAlbum: Boolean, forComment: Boolean): HttpUrl =
    this.sendFunctionAsync(TdApi.GetMessageLink(chatId, messageId, mediaTimestamp, forAlbum, forComment))
...
suspend fun TelegramFlow.sendMessage(
  ...
  replyMarkup: ReplyMarkup?,
  inputMessageContent: InputMessageContent?
): Message = this.sendFunctionAsync(SendMessage(chatId, messageThreadId, replyToMessageId, options,
...
): Messages = this.sendFunctionAsync(TdApi.SendMessageAlbum(chatId, messageThreadId, replyToMessageId, options,
