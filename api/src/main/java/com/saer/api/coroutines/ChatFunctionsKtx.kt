...
suspend fun TelegramFlow.addChatMember(
    ...
    userId: Long,
    forwardLimit: Int
) = this.sendFunctionLaunch(AddChatMember(chatId, userId, forwardLimit))

suspend fun TelegramFlow.loadChats() = this.sendFunctionLaunch(LoadChats(ChatListMain(), 50))
...
suspend fun TelegramFlow.addChatMembers(chatId: Long, userIds: LongArray?) =
    this.sendFunctionLaunch(AddChatMembers(chatId, userIds))
...
suspend fun TelegramFlow.addRecentlyFoundChat(chatId: Long) =
    this.sendFunctionLaunch(AddRecentlyFoundChat(chatId))
...
suspend fun TelegramFlow.checkChatInviteLink(inviteLink: String?): ChatInviteLinkInfo =
    this.sendFunctionAsync(CheckChatInviteLink(inviteLink))
...
suspend fun TelegramFlow.checkChatUsername(
    chatId: Long,
    username: String?
): CheckChatUsernameResult = this.sendFunctionAsync(CheckChatUsername(chatId, username))
 ...
 * @param chatId Chat identifier.
 */
suspend fun TelegramFlow.closeChat(chatId: Long) = this.sendFunctionLaunch(CloseChat(chatId))
...
suspend fun TelegramFlow.closeSecretChat(secretChatId: Int) =
    this.sendFunctionLaunch(CloseSecretChat(secretChatId))
...
suspend fun TelegramFlow.createBasicGroupChat(basicGroupId: Long, force: Boolean): Chat =
    this.sendFunctionAsync(CreateBasicGroupChat(basicGroupId, force))
...
suspend fun TelegramFlow.createNewBasicGroupChat(userIds: LongArray?, title: String?): Chat =
    this.sendFunctionAsync(CreateNewBasicGroupChat(userIds, title))
...
suspend fun TelegramFlow.createNewSecretChat(userId: Long): Chat =
    this.sendFunctionAsync(CreateNewSecretChat(userId))
...
suspend fun TelegramFlow.createPrivateChat(userId: Long, force: Boolean): Chat =
    this.sendFunctionAsync(CreatePrivateChat(userId, force))
...
suspend fun TelegramFlow.createSecretChat(secretChatId: Int): Chat =
    this.sendFunctionAsync(CreateSecretChat(secretChatId))
...
suspend fun TelegramFlow.createSupergroupChat(supergroupId: Long, force: Boolean): Chat =
    this.sendFunctionAsync(CreateSupergroupChat(supergroupId, force))
...
suspend fun TelegramFlow.deleteChatHistory(
    ...
    revoke: Boolean
) = this.sendFunctionLaunch(DeleteChatHistory(chatId, removeFromChatList, revoke))
...
suspend fun TelegramFlow.deleteChatReplyMarkup(chatId: Long, messageId: Long) =
    this.sendFunctionLaunch(DeleteChatReplyMarkup(chatId, messageId))
 ...
 * @return [Chat] A chat. (Can be a private chat, basic group, supergroup, or secret chat.)
 */
suspend fun TelegramFlow.getChat(chatId: Long): Chat = this.sendFunctionAsync(GetChat(chatId))
...
suspend fun TelegramFlow.getChatAdministrators(chatId: Long): ChatAdministrators =
    this.sendFunctionAsync(GetChatAdministrators(chatId))
...
suspend fun TelegramFlow.getChatMember(chatId: Long, memberId: MessageSender): ChatMember =
    this.sendFunctionAsync(GetChatMember(chatId, memberId))
...
suspend fun TelegramFlow.getChatMessageByDate(chatId: Long, date: Int): Message =
    this.sendFunctionAsync(GetChatMessageByDate(chatId, date))
...
suspend fun TelegramFlow.getChatMessageCount(
    ...
    returnLocal: Boolean
): Count = this.sendFunctionAsync(GetChatMessageCount(chatId, filter, returnLocal))
...
suspend fun TelegramFlow.getChatNotificationSettingsExceptions(
    ...
    this.sendFunctionAsync(GetChatNotificationSettingsExceptions(scope, compareSound))
...
suspend fun TelegramFlow.getChatPinnedMessage(chatId: Long): Message =
    this.sendFunctionAsync(GetChatPinnedMessage(chatId))
...
suspend fun TelegramFlow.getChatScheduledMessages(chatId: Long): Messages =
    this.sendFunctionAsync(GetChatScheduledMessages(chatId))
...
suspend fun TelegramFlow.getChats(
    chatList: ChatList?,
    limit: Int
): Chats = this.sendFunctionAsync(GetChats(chatList, limit))
...
suspend fun TelegramFlow.getCreatedPublicChats(type: PublicChatType?): Chats =
    this.sendFunctionAsync(GetCreatedPublicChats(type))
...
suspend fun TelegramFlow.getInactiveSupergroupChats(): Chats =
    this.sendFunctionAsync(GetInactiveSupergroupChats())
...
suspend fun TelegramFlow.getSecretChat(secretChatId: Int): SecretChat =
    this.sendFunctionAsync(GetSecretChat(secretChatId))
...
suspend fun TelegramFlow.getSuitableDiscussionChats(): Chats =
    this.sendFunctionAsync(GetSuitableDiscussionChats())
...
suspend fun TelegramFlow.getTopChats(category: TopChatCategory?, limit: Int): Chats =
    this.sendFunctionAsync(GetTopChats(category, limit))
 ...
 * @param chatId Chat identifier.
 */
suspend fun TelegramFlow.joinChat(chatId: Long) = this.sendFunctionLaunch(JoinChat(chatId))
...
suspend fun TelegramFlow.joinChatByInviteLink(inviteLink: String?): Chat =
    this.sendFunctionAsync(JoinChatByInviteLink(inviteLink))
 ...
 * @param chatId Chat identifier.
 */
suspend fun TelegramFlow.leaveChat(chatId: Long) = this.sendFunctionLaunch(LeaveChat(chatId))
 ...
 * @param chatId Chat identifier.
 */
suspend fun TelegramFlow.openChat(chatId: Long) = this.sendFunctionLaunch(OpenChat(chatId))
...
suspend fun TelegramFlow.readAllChatMentions(chatId: Long) =
    this.sendFunctionLaunch(ReadAllChatMentions(chatId))
...
suspend fun TelegramFlow.removeChatActionBar(chatId: Long) =
    this.sendFunctionLaunch(RemoveChatActionBar(chatId))
...
suspend fun TelegramFlow.removeRecentlyFoundChat(chatId: Long) =
    this.sendFunctionLaunch(RemoveRecentlyFoundChat(chatId))
...
suspend fun TelegramFlow.removeTopChat(category: TopChatCategory?, chatId: Long) =
    this.sendFunctionLaunch(RemoveTopChat(category, chatId))
...
) = this.sendFunctionLaunch(ReportChat(chatId, messageIds, reason, ""))
...
): ChatMembers = this.sendFunctionAsync(SearchChatMembers(chatId, query, limit, filter))
...
suspend fun TelegramFlow.searchChatRecentLocationMessages(chatId: Long, limit: Int): Messages =
    this.sendFunctionAsync(SearchChatRecentLocationMessages(chatId, limit))
...
suspend fun TelegramFlow.searchChats(query: String?, limit: Int): Chats =
    this.sendFunctionAsync(SearchChats(query, limit))
...
suspend fun TelegramFlow.searchChatsNearby(location: Location?): ChatsNearby =
    this.sendFunctionAsync(SearchChatsNearby(location))
...
suspend fun TelegramFlow.searchChatsOnServer(query: String?, limit: Int): Chats =
    this.sendFunctionAsync(SearchChatsOnServer(query, limit))
...
suspend fun TelegramFlow.searchPublicChat(username: String?): Chat =
    this.sendFunctionAsync(SearchPublicChat(username))
...
suspend fun TelegramFlow.searchPublicChats(query: String?): Chats =
    this.sendFunctionAsync(SearchPublicChats(query))
 ...
 */
suspend fun TelegramFlow.sendChatAction(chatId: Long, messageThreadId: Long, action: ChatAction?) =
    this.sendFunctionLaunch(SendChatAction(chatId, messageThreadId, action))
...
suspend fun TelegramFlow.sendChatScreenshotTakenNotification(chatId: Long) =
    this.sendFunctionLaunch(SendChatScreenshotTakenNotification(chatId))
...
suspend fun TelegramFlow.setChatClientData(chatId: Long, clientData: String?) =
    this.sendFunctionLaunch(SetChatClientData(chatId, clientData))
...
suspend fun TelegramFlow.setChatDescription(chatId: Long, description: String?) =
    this.sendFunctionLaunch(SetChatDescription(chatId, description))
...
suspend fun TelegramFlow.setChatDiscussionGroup(chatId: Long, discussionChatId: Long) =
    this.sendFunctionLaunch(SetChatDiscussionGroup(chatId, discussionChatId))
...
//    this.sendFunctionLaunch(SetChatDraftMessage(chatId, draftMessage))
...
suspend fun TelegramFlow.setChatLocation(chatId: Long, location: ChatLocation?) =
    this.sendFunctionLaunch(SetChatLocation(chatId, location))
...
//) = this.sendFunctionLaunch(SetChatMemberStatus(chatId, userId, status))
...
suspend fun TelegramFlow.setChatNotificationSettings(
    ...
    this.sendFunctionLaunch(SetChatNotificationSettings(chatId, notificationSettings))
...
suspend fun TelegramFlow.setChatPermissions(chatId: Long, permissions: ChatPermissions?) =
    this.sendFunctionLaunch(SetChatPermissions(chatId, permissions))
...
//    this.sendFunctionLaunch(SetChatPhoto(chatId, photo))
...
suspend fun TelegramFlow.setChatSlowModeDelay(chatId: Long, slowModeDelay: Int) =
    this.sendFunctionLaunch(SetChatSlowModeDelay(chatId, slowModeDelay))
...
suspend fun TelegramFlow.setChatTitle(chatId: Long, title: String?) =
    this.sendFunctionLaunch(SetChatTitle(chatId, title))
...
suspend fun TelegramFlow.setPinnedChats(chatList: ChatList?, chatIds: LongArray?) =
    this.sendFunctionLaunch(SetPinnedChats(chatList, chatIds))
...
suspend fun TelegramFlow.toggleChatIsMarkedAsUnread(chatId: Long, isMarkedAsUnread: Boolean) =
    this.sendFunctionLaunch(ToggleChatIsMarkedAsUnread(chatId, isMarkedAsUnread))
...
//    this.sendFunctionLaunch(ToggleChatIsPinned(chatId, isPinned))
...
//    userId: Int,
//    password: String?
//) = this.sendFunctionLaunch(TransferChatOwnership(chatId, userId, password))
...
//    this.sendFunctionLaunch(UnpinChatMessage(chatId))
...
suspend fun TelegramFlow.upgradeBasicGroupChatToSupergroupChat(chatId: Long): Chat =
    this.sendFunctionAsync(UpgradeBasicGroupChatToSupergroupChat(chatId))
